...
namespace FlightReservationSystem.API
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("GenerateToken")]
        public async Task<IActionResult> GenerateToken(WebApiFlightReservationLoginModel.LoginModel _userData)
        {
            if (_userData != null && _userData.UserName != null && _userData.Password != null)
            {
                ...
                if (user != null)
                {
                    ...
                    string jwttoken = Convert.ToString(new JwtSecurityTokenHandler().WriteToken(token)); ;
