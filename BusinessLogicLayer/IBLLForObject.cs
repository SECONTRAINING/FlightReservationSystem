...
namespace BusinessLogicLayer
{
    ...
    public interface IBLLForFlightDetails
    {
        ...
        int [] getFLightIdbySourcedestination(string source, string destination);
        List<FlightDetails> GetFlightDetailsByArrayId(int[] FlightId);
    }
    ...
    public interface IBLLForFlightSchedule
    {
        ...
        int [] getFlightIdByScheduleDay(string day);

       // getFLightDetailsbySourcedestination

    }

    public interface IBLLForUsers
    {
        List<FlightDetails> getFlightsByDayAndLocation(string day, string source, string destination);
    }
}
